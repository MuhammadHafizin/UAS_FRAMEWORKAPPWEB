...
<body>
    ...
    <!-- Tamoilan halaman Home-->
    <section class="konten">
        <div class="container">
            <div class="dropdown-divider"></div>
            <h1 class="fa fa-th-large fa-3x">Semua kategori</h1>
            <div class="dropdown-divider"></div>
            <div class="row">
                <?php $ambil = $koneksi->query("SELECT * FROM makanan"); ?>
                <?php while ($permakanan = $ambil->fetch_assoc()) { ?>
                <div class="col-md-3">
                    <div class="thumbmail">
                        <img src="foto_makanan/<?php echo $permakanan['foto_makanan']; ?>" alt="">
                        <div class="caption">
                            <h3><?php echo $permakanan['nama_makanan']; ?></h3>
                            <h5>Rp.
                                <?Php echo $permakanan['harga_makanan']; ?>
                            </h5>
                            <a href="beli.php?id=<?php echo $permakanan['id_makanan']; ?>"
    ...
    <section class="konten">
        <div class="container">
            ...
            <div class="row">
                ...
                <?php while ($perminuman = $ambil->fetch_assoc()) { ?>
                <div class="col-md-3">
                    <div class="thumbmail">
                        <img src="foto_minuman/<?php echo $perminuman['foto_minuman']; ?>" alt="">
                        <div class="caption">
                            <h3><?php echo $perminuman['nama_minuman']; ?></h3>
                            <h5>Rp.
                                <?Php echo $perminuman['harga_minuman']; ?>
                            </h5>
